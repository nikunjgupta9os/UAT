...
import UploadSummaryItem from "./previewSummary.tsx";
import FileUpload from "./uploadInput.tsx";
...
import {
  ...
  lcValidationConfig,
  soValidationConfig,
  creditorValidationConfig,
  debtorsValidationConfig,
  validateFileContent,
  validatePreviewData,
  templates,
} from "./realValidation.ts";
import TemplateGrid from "./templateGrid.tsx";
import handleDownload  from "./handleDownload.ts";
import type { PreviewState, UploadedFile } from "./type.ts";
import convertToCSVBlob from "./convertToCSVBlob.ts";
import parseExcel from './parseExcel.ts'


// Helper function to map selected type to validation config
const getValidationConfigFromSelected = (selectedType: string) => {
  switch (selectedType) {
    case "PO":
      return poValidationConfig;
    case "LC":
      return lcValidationConfig;
    case "SO":
      return soValidationConfig;
    case "GRN":
      return grnValidationConfig;
    case "Creditor":
      return creditorValidationConfig;
    case "Debtors":
      return debtorsValidationConfig;
    default:
      return soValidationConfig;
  }
};
      ...
      <div className="space-y-6">
        <div className="bg-secondary-color-lt border-border p-6 rounded-lg shadow-sm border">
          <FileUpload
            ...
            title={"Please select a type of exposure first."}
